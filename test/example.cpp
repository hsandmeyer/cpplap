...
int main()
{
    ...
    std::cout << "Simple line x_vec = r_vec + t * v_vec" << std::endl;
    ...
    std::cout << "Simple plane: ax + by + cz = d" << std::endl;
    ...
    std::cout << "Hesse plane: (r_vec - x_vec) * n_vec = 0" << std::endl;
    Vect<double>       n{1, 1, 1};
    ...
    std::cout << "Parametric plane: x_vec = r_vec + s*u_vec + t*v_vec " << std::endl;
    Vect<double> u{1, -1, 0};
    v = {0, 1, -1};
